...

{
  ...
  if((this.authenticationRequest.username=='ravi'&& this.authenticationRequest.password=='ravi123')){
  ...
  //console.log("form is submitted");
  if((this.authenticationRequest.username=='rec'&& this.authenticationRequest.password=='rec123')){
  ...
  if((this.authenticationRequest.username=='guest'&& this.authenticationRequest.password=='guest123')){
